    ...
    <div className="mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col">
                ...
                <img src={image?URL.createObjectURL(image):""} className='rounded-md w-full object-cover' alt="" />
            </div>
            ...
            <div className="flex flex-col">
                ...
                <div className="rounded-md border border-gray-300 h-full bg-layer relative overflow-hidden">
                    <img src={resultImage?resultImage:""} className='w-full object-cover' alt="" />
                    {!resultImage && image &&(
        ...
        {resultImage &&(
            <div className="flex justify-center sm:justify-end items-center flex-wrap gap-4 mt-6">
                <button className="border text-indigo-600 font-semibold py-2 px-4 rounded-full text-lg hover:scale-105 transition-all durtaion-300"
                onClick={()=>navigate("/")}
                >
                    Try another image
                </button>
